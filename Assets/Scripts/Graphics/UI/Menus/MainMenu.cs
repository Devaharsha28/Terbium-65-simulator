...
namespace DLS.Graphics
{
	public static class MainMenu
	{
		...
		static readonly string authorString = "Fork by Devaharsha28";
		static readonly string versionString = "Version: v0.1";
		...
		public static void Draw()
		{
			...
			UI.DrawFullscreenPanel(Color.black);
			const string title = "TERBIUM 65";
		...
		static void DrawSettingsScreen()
		{
			...
			using (UI.BeginBoundsScope(true))
			{
				...
				// -- Theme --
				UI.DrawText("Theme", theme.FontRegular, theme.FontSizeRegular, pos, Anchor.CentreLeft, Color.white);
				bool editThemeClicked = UI.Button("EDIT THEME", theme.MenuButtonTheme,
					new Vector2(elementOriginRight, pos.y), new Vector2(16, DrawSettings.ButtonHeight),
					true, false, true, Anchor.CentreRight);
				if (editThemeClicked)
				{
				...
				// Background panel
				UI.ModifyPanel(backgroundPanelID, UI.GetCurrentBoundsScope().Centre, UI.GetCurrentBoundsScope().Size + Vector2.one * 3, theme.MenuPanelCol);
			}
		...
		static void DrawAboutScreen()
		{
			...
			string aboutText = "Terbium 65\n\n" +
				"A digital logic simulation environment for designing\n" +
				"and experimenting with ternary circuits\n" +
				"and ternary computer architectures.\n\n" +
				"Originally created by Sebastian Lague\n" +
				"as Digital Logic Sim.\n\n" +
				"Forked and modified by DevaHarsha28.";
			UI.DrawText(aboutText, theme.font, theme.fontSize, UI.Centre, Anchor.Centre, Color.white);
		...
		{
			DrawSettings.UIThemeDLS theme = DrawSettings.ActiveUITheme;
			UI.DrawPanel(UI.BottomLeft, new Vector2(UI.Width, 4), theme.MenuPanelCol, Anchor.BottomLeft);
